...
for lamda = linspace(0.0001,0.1,size)
    i = i + 1
    [a,b,k(i),l(i)] = bisectionDivAlgorithm(df1, lamda,0,4);
end
subplot(3,1,1);
plot(l,k,'-r','LineWidth',1)
...
for lamda = linspace(0.001,0.1,size)
    i = i + 1
    [a,b,k(i),l(i)] = bisectionDivAlgorithm(df2, lamda,0,4);
end
subplot(3,1,2);
plot(l,k,'-r','LineWidth',1)
...
for lamda = linspace(0.001,0.1,size)
    i = i + 1
    [a,b,k(i),l(i)] = bisectionDivAlgorithm(df3, lamda,0,3);
end
subplot(3,1,3);
plot(l,k,'-r','LineWidth',1)
...
[a,b,k] = bisectionDivAlgorithm(df1,0.0021,0,4);
...
subplot(3,1,2)
[a,b,k] = bisectionDivAlgorithm(df1,0.01,0,4);
...
subplot(3,1,3)  
[a,b,k] = bisectionDivAlgorithm(df1,0.02,0,4);
for i=0:1:k-1
    plot(i,a(i+1),'ob')
    hold on
    plot(i,b(i+1),'*r','Color','blue')
...
figure;
subplot(3,1,1)
[a,b,k] = bisectionDivAlgorithm(df2,0.0021,0,4);
...
subplot(3,1,2)
[a,b,k] = bisectionDivAlgorithm(df2,0.01,0,4);
...
subplot(3,1,3)  
[a,b,k] = bisectionDivAlgorithm(df2,0.02,0,4);
for i=0:1:k-1
    plot(i,a(i+1),'ob')
    hold on
    plot(i,b(i+1),'*r','Color','blue')
...
figure;
subplot(3,1,1)
[a,b,k] = bisectionDivAlgorithm(df3,0.0021,0,4);
...
subplot(3,1,2)
[a,b,k] = bisectionDivAlgorithm(df3,0.01,0,4);
...
subplot(3,1,3)  
[a,b,k] = bisectionDivAlgorithm(df3,0.02,0,4);
for i=0:1:k-1
    plot(i,a(i+1),'ob')
    hold on
    plot(i,b(i+1),'*r','Color','blue')
