...
for lamda = linspace(0.0001,0.1,size)
    i = i + 1
    [a,b,k(i),l(i)] = custom_fibonacci(f_1, lamda,0,4);
end
subplot(3,1,1);
...
for lamda = linspace(0.001,0.1,size)
    i = i + 1
    [a,b,k(i),l(i)] = custom_fibonacci(f_2, lamda,0,4);
end
subplot(3,1,2);
plot(l,k+1,'-r','LineWidth',1)
...
for lamda = linspace(0.001,0.1,size)
    i = i + 1
    [a,b,k(i),l(i)] = custom_fibonacci(f_3, lamda,0,3);
end
subplot(3,1,3);
plot(l,k+1,'-r','LineWidth',1)
...
figure;
subplot(3,1,1)
[a,b,k] = custom_fibonacci(f_1,0.0021,0,4);
...
subplot(3,1,2)
[a,b,k] = custom_fibonacci(f_1,0.01,0,4);
...
subplot(3,1,3)  
[a,b,k] = custom_fibonacci(f_1,0.02,0,4);
for i=0:1:k-1
    plot(i,a(i+1),'ob')
    hold on
    plot(i,b(i+1),'*r','Color','blue')
...
figure;
subplot(3,1,1)
[a,b,k] = custom_fibonacci(f_2,0.0021,0,4);
...
subplot(3,1,2)
[a,b,k] = custom_fibonacci(f_2,0.01,0,4);
...
subplot(3,1,3)  
[a,b,k] = custom_fibonacci(f_2,0.02,0,4);
for i=0:1:k-1
    plot(i,a(i+1),'ob')
    hold on
    plot(i,b(i+1),'*r','Color','blue')
...
figure;
subplot(3,1,1)
[a,b,k] = custom_fibonacci(f_3,0.0021,0,4);
...
subplot(3,1,2)
[a,b,k] = custom_fibonacci(f_3,0.01,0,4);
...
subplot(3,1,3)  
[a,b,k] = custom_fibonacci(f_3,0.02,0,4);
for i=0:1:k-1
    plot(i,a(i+1),'ob')
    hold on
    plot(i,b(i+1),'*r','Color','blue')
