...
\clearpage
\subsubsection*{Σημείο (0,0) της συνάρτησης f}
\begin{figure*}[h!]	
     \centering  
     \advance\leftskip-0.2cm  
  \includegraphics[width=120mm,scale=2]{t1a.jpg}
\end{figure*} 
Στο σημείο (0,0) η παράγωγος είναι μηδέν οπότε ο αλγόριθμος τερματίζεται πρόωρα και δεν μπορούμε να μετακινηθούμε για την εύρεση ελαχίστου.
\subsubsection*{Σημείο (-1,-1) της συνάρτησης f}
\begin{figure*}[h!]	
     \centering  
     \advance\leftskip-0.2cm  
  \includegraphics[width=120mm,scale=2]{t1b.jpg}
\end{figure*} 
Στο σημείο (-1,-1) μετά απο 277 επαναλήψεις καταλήγουμε σε τοπικό ελάχιστο (-1.22,-0.03) με δοσμένη ακρίβεια e=$10^{-4}$.
\clearpage
\subsubsection*{Σημείο (1,1) της συνάρτησης f}
\begin{figure*}[h!]	
     \centering  
     \advance\leftskip-0.2cm  
  \includegraphics[width=120mm,scale=2]{t1c.jpg}
\end{figure*} 
Στο σημείο (1,1) μετά απο 680 επαναλήψεις καταλήγουμε σε τοπικό μέγιστο (0.85,1.83) με δοσμένη ακρίβεια e=$10^{-4}$.
\newpage 
